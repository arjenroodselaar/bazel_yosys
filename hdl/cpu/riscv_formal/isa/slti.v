...
`endif
  ...
  // SLTI instruction
  wire [`RISCV_FORMAL_XLEN-1:0] result = $signed(rvfi_rs1_rdata) < $signed(instruction_imm);
  assign spec_valid = rvfi_valid && !instruction_padding && instruction_funct3 == 3'b 010 && instruction_opcode == 7'b 0010011;
