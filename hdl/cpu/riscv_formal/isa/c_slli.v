...
module rvfi_instruction_c_slli (
  input                                 rvfi_valid,
...
`endif
  ...
  assign spec_valid = rvfi_valid && !instruction_padding && instruction_funct3 == 3'b 000 && instruction_opcode == 2'b 10 && (!instruction_shamt[5] || `RISCV_FORMAL_XLEN == 64);
