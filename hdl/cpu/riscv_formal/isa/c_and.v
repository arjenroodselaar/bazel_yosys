...
`endif
  ...
  assign spec_valid = rvfi_valid && !instruction_padding && instruction_funct6 == 6'b 100011 && instruction_funct2 == 2'b 11 && instruction_opcode == 2'b 01;
