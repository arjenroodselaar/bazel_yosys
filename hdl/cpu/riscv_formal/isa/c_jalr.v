...
module rvfi_instruction_c_jalr (
  input                                 rvfi_valid,
...
`endif
  ...
  assign spec_valid = rvfi_valid && !instruction_padding && instruction_funct4 == 4'b 1001 && instruction_rs1_rd && !instruction_rs2 && instruction_opcode == 2'b 10;
