...
module rvfi_instruction_c_addiw (
  input                                 rvfi_valid,
...
`endif
  ...
  // C_ADDIW instruction
  wire [31:0] result = rvfi_rs1_rdata[31:0] + instruction_imm[31:0];
  assign spec_valid = rvfi_valid && !instruction_padding && instruction_funct3 == 3'b 001 && instruction_opcode == 2'b 01 && instruction_rs1_rd != 5'd 0;
