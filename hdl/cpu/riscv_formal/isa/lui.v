...
`endif
  ...
  // LUI instruction
  assign spec_valid = rvfi_valid && !instruction_padding && instruction_opcode == 7'b 0110111;
  assign spec_rd_addr = instruction_rd;
  assign spec_rd_wdata = spec_rd_addr ? instruction_imm : 0;
