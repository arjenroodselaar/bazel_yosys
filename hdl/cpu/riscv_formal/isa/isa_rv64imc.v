...
`endif
  ...
  wire                                spec_instruction_addiw_valid;
  wire                                spec_instruction_addiw_trap;
  wire [                       4 : 0] spec_instruction_addiw_rs1_addr;
  wire [                       4 : 0] spec_instruction_addiw_rs2_addr;
  wire [                       4 : 0] spec_instruction_addiw_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_addiw_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_addiw_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_addiw_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_addiw_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_addiw_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_addiw_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_addiw_csr_misa_rmask;
`endif

  rvfi_instruction_addiw addiw (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_addiw_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_addiw_valid),
    .spec_trap(spec_instruction_addiw_trap),
    .spec_rs1_addr(spec_instruction_addiw_rs1_addr),
    .spec_rs2_addr(spec_instruction_addiw_rs2_addr),
    .spec_rd_addr(spec_instruction_addiw_rd_addr),
    .spec_rd_wdata(spec_instruction_addiw_rd_wdata),
    .spec_pc_wdata(spec_instruction_addiw_pc_wdata),
    .spec_mem_addr(spec_instruction_addiw_mem_addr),
    .spec_mem_rmask(spec_instruction_addiw_mem_rmask),
    .spec_mem_wmask(spec_instruction_addiw_mem_wmask),
    .spec_mem_wdata(spec_instruction_addiw_mem_wdata)
  );

  wire                                spec_instruction_addw_valid;
  wire                                spec_instruction_addw_trap;
  wire [                       4 : 0] spec_instruction_addw_rs1_addr;
  wire [                       4 : 0] spec_instruction_addw_rs2_addr;
  wire [                       4 : 0] spec_instruction_addw_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_addw_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_addw_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_addw_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_addw_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_addw_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_addw_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_addw_csr_misa_rmask;
`endif

  rvfi_instruction_addw addw (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_addw_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_addw_valid),
    .spec_trap(spec_instruction_addw_trap),
    .spec_rs1_addr(spec_instruction_addw_rs1_addr),
    .spec_rs2_addr(spec_instruction_addw_rs2_addr),
    .spec_rd_addr(spec_instruction_addw_rd_addr),
    .spec_rd_wdata(spec_instruction_addw_rd_wdata),
    .spec_pc_wdata(spec_instruction_addw_pc_wdata),
    .spec_mem_addr(spec_instruction_addw_mem_addr),
    .spec_mem_rmask(spec_instruction_addw_mem_rmask),
    .spec_mem_wmask(spec_instruction_addw_mem_wmask),
    .spec_mem_wdata(spec_instruction_addw_mem_wdata)
  );
...
`endif
  ...
  wire                                spec_instruction_c_addiw_valid;
  wire                                spec_instruction_c_addiw_trap;
  wire [                       4 : 0] spec_instruction_c_addiw_rs1_addr;
  wire [                       4 : 0] spec_instruction_c_addiw_rs2_addr;
  wire [                       4 : 0] spec_instruction_c_addiw_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_addiw_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_addiw_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_addiw_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_c_addiw_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_c_addiw_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_addiw_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_addiw_csr_misa_rmask;
`endif

  rvfi_instruction_c_addiw c_addiw (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_c_addiw_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_c_addiw_valid),
    .spec_trap(spec_instruction_c_addiw_trap),
    .spec_rs1_addr(spec_instruction_c_addiw_rs1_addr),
    .spec_rs2_addr(spec_instruction_c_addiw_rs2_addr),
    .spec_rd_addr(spec_instruction_c_addiw_rd_addr),
    .spec_rd_wdata(spec_instruction_c_addiw_rd_wdata),
    .spec_pc_wdata(spec_instruction_c_addiw_pc_wdata),
    .spec_mem_addr(spec_instruction_c_addiw_mem_addr),
    .spec_mem_rmask(spec_instruction_c_addiw_mem_rmask),
    .spec_mem_wmask(spec_instruction_c_addiw_mem_wmask),
    .spec_mem_wdata(spec_instruction_c_addiw_mem_wdata)
  );

  wire                                spec_instruction_c_addw_valid;
  wire                                spec_instruction_c_addw_trap;
  wire [                       4 : 0] spec_instruction_c_addw_rs1_addr;
  wire [                       4 : 0] spec_instruction_c_addw_rs2_addr;
  wire [                       4 : 0] spec_instruction_c_addw_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_addw_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_addw_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_addw_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_c_addw_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_c_addw_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_addw_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_addw_csr_misa_rmask;
`endif

  rvfi_instruction_c_addw c_addw (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_c_addw_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_c_addw_valid),
    .spec_trap(spec_instruction_c_addw_trap),
    .spec_rs1_addr(spec_instruction_c_addw_rs1_addr),
    .spec_rs2_addr(spec_instruction_c_addw_rs2_addr),
    .spec_rd_addr(spec_instruction_c_addw_rd_addr),
    .spec_rd_wdata(spec_instruction_c_addw_rd_wdata),
    .spec_pc_wdata(spec_instruction_c_addw_pc_wdata),
    .spec_mem_addr(spec_instruction_c_addw_mem_addr),
    .spec_mem_rmask(spec_instruction_c_addw_mem_rmask),
    .spec_mem_wmask(spec_instruction_c_addw_mem_wmask),
    .spec_mem_wdata(spec_instruction_c_addw_mem_wdata)
  );
...
`endif
  ...
  wire                                spec_instruction_c_ld_valid;
  wire                                spec_instruction_c_ld_trap;
  wire [                       4 : 0] spec_instruction_c_ld_rs1_addr;
  wire [                       4 : 0] spec_instruction_c_ld_rs2_addr;
  wire [                       4 : 0] spec_instruction_c_ld_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_ld_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_ld_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_ld_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_c_ld_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_c_ld_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_ld_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_ld_csr_misa_rmask;
`endif

  rvfi_instruction_c_ld c_ld (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_c_ld_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_c_ld_valid),
    .spec_trap(spec_instruction_c_ld_trap),
    .spec_rs1_addr(spec_instruction_c_ld_rs1_addr),
    .spec_rs2_addr(spec_instruction_c_ld_rs2_addr),
    .spec_rd_addr(spec_instruction_c_ld_rd_addr),
    .spec_rd_wdata(spec_instruction_c_ld_rd_wdata),
    .spec_pc_wdata(spec_instruction_c_ld_pc_wdata),
    .spec_mem_addr(spec_instruction_c_ld_mem_addr),
    .spec_mem_rmask(spec_instruction_c_ld_mem_rmask),
    .spec_mem_wmask(spec_instruction_c_ld_mem_wmask),
    .spec_mem_wdata(spec_instruction_c_ld_mem_wdata)
  );

  wire                                spec_instruction_c_ldsp_valid;
  wire                                spec_instruction_c_ldsp_trap;
  wire [                       4 : 0] spec_instruction_c_ldsp_rs1_addr;
  wire [                       4 : 0] spec_instruction_c_ldsp_rs2_addr;
  wire [                       4 : 0] spec_instruction_c_ldsp_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_ldsp_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_ldsp_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_ldsp_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_c_ldsp_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_c_ldsp_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_ldsp_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_ldsp_csr_misa_rmask;
`endif

  rvfi_instruction_c_ldsp c_ldsp (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_c_ldsp_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_c_ldsp_valid),
    .spec_trap(spec_instruction_c_ldsp_trap),
    .spec_rs1_addr(spec_instruction_c_ldsp_rs1_addr),
    .spec_rs2_addr(spec_instruction_c_ldsp_rs2_addr),
    .spec_rd_addr(spec_instruction_c_ldsp_rd_addr),
    .spec_rd_wdata(spec_instruction_c_ldsp_rd_wdata),
    .spec_pc_wdata(spec_instruction_c_ldsp_pc_wdata),
    .spec_mem_addr(spec_instruction_c_ldsp_mem_addr),
    .spec_mem_rmask(spec_instruction_c_ldsp_mem_rmask),
    .spec_mem_wmask(spec_instruction_c_ldsp_mem_wmask),
    .spec_mem_wdata(spec_instruction_c_ldsp_mem_wdata)
  );
...
`endif
  ...
  wire                                spec_instruction_c_sd_valid;
  wire                                spec_instruction_c_sd_trap;
  wire [                       4 : 0] spec_instruction_c_sd_rs1_addr;
  wire [                       4 : 0] spec_instruction_c_sd_rs2_addr;
  wire [                       4 : 0] spec_instruction_c_sd_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_sd_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_sd_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_sd_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_c_sd_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_c_sd_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_sd_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_sd_csr_misa_rmask;
`endif

  rvfi_instruction_c_sd c_sd (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_c_sd_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_c_sd_valid),
    .spec_trap(spec_instruction_c_sd_trap),
    .spec_rs1_addr(spec_instruction_c_sd_rs1_addr),
    .spec_rs2_addr(spec_instruction_c_sd_rs2_addr),
    .spec_rd_addr(spec_instruction_c_sd_rd_addr),
    .spec_rd_wdata(spec_instruction_c_sd_rd_wdata),
    .spec_pc_wdata(spec_instruction_c_sd_pc_wdata),
    .spec_mem_addr(spec_instruction_c_sd_mem_addr),
    .spec_mem_rmask(spec_instruction_c_sd_mem_rmask),
    .spec_mem_wmask(spec_instruction_c_sd_mem_wmask),
    .spec_mem_wdata(spec_instruction_c_sd_mem_wdata)
  );

  wire                                spec_instruction_c_sdsp_valid;
  wire                                spec_instruction_c_sdsp_trap;
  wire [                       4 : 0] spec_instruction_c_sdsp_rs1_addr;
  wire [                       4 : 0] spec_instruction_c_sdsp_rs2_addr;
  wire [                       4 : 0] spec_instruction_c_sdsp_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_sdsp_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_sdsp_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_sdsp_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_c_sdsp_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_c_sdsp_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_sdsp_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_sdsp_csr_misa_rmask;
`endif

  rvfi_instruction_c_sdsp c_sdsp (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_c_sdsp_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_c_sdsp_valid),
    .spec_trap(spec_instruction_c_sdsp_trap),
    .spec_rs1_addr(spec_instruction_c_sdsp_rs1_addr),
    .spec_rs2_addr(spec_instruction_c_sdsp_rs2_addr),
    .spec_rd_addr(spec_instruction_c_sdsp_rd_addr),
    .spec_rd_wdata(spec_instruction_c_sdsp_rd_wdata),
    .spec_pc_wdata(spec_instruction_c_sdsp_pc_wdata),
    .spec_mem_addr(spec_instruction_c_sdsp_mem_addr),
    .spec_mem_rmask(spec_instruction_c_sdsp_mem_rmask),
    .spec_mem_wmask(spec_instruction_c_sdsp_mem_wmask),
    .spec_mem_wdata(spec_instruction_c_sdsp_mem_wdata)
  );
...
`endif
  ...
  wire                                spec_instruction_c_subw_valid;
  wire                                spec_instruction_c_subw_trap;
  wire [                       4 : 0] spec_instruction_c_subw_rs1_addr;
  wire [                       4 : 0] spec_instruction_c_subw_rs2_addr;
  wire [                       4 : 0] spec_instruction_c_subw_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_subw_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_subw_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_subw_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_c_subw_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_c_subw_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_subw_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_c_subw_csr_misa_rmask;
`endif

  rvfi_instruction_c_subw c_subw (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_c_subw_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_c_subw_valid),
    .spec_trap(spec_instruction_c_subw_trap),
    .spec_rs1_addr(spec_instruction_c_subw_rs1_addr),
    .spec_rs2_addr(spec_instruction_c_subw_rs2_addr),
    .spec_rd_addr(spec_instruction_c_subw_rd_addr),
    .spec_rd_wdata(spec_instruction_c_subw_rd_wdata),
    .spec_pc_wdata(spec_instruction_c_subw_pc_wdata),
    .spec_mem_addr(spec_instruction_c_subw_mem_addr),
    .spec_mem_rmask(spec_instruction_c_subw_mem_rmask),
    .spec_mem_wmask(spec_instruction_c_subw_mem_wmask),
    .spec_mem_wdata(spec_instruction_c_subw_mem_wdata)
  );
...
`endif
  ...
  wire                                spec_instruction_div_valid;
  wire                                spec_instruction_div_trap;
  wire [                       4 : 0] spec_instruction_div_rs1_addr;
  wire [                       4 : 0] spec_instruction_div_rs2_addr;
  wire [                       4 : 0] spec_instruction_div_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_div_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_div_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_div_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_div_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_div_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_div_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_div_csr_misa_rmask;
`endif

  rvfi_instruction_div div (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_div_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_div_valid),
    .spec_trap(spec_instruction_div_trap),
    .spec_rs1_addr(spec_instruction_div_rs1_addr),
    .spec_rs2_addr(spec_instruction_div_rs2_addr),
    .spec_rd_addr(spec_instruction_div_rd_addr),
    .spec_rd_wdata(spec_instruction_div_rd_wdata),
    .spec_pc_wdata(spec_instruction_div_pc_wdata),
    .spec_mem_addr(spec_instruction_div_mem_addr),
    .spec_mem_rmask(spec_instruction_div_mem_rmask),
    .spec_mem_wmask(spec_instruction_div_mem_wmask),
    .spec_mem_wdata(spec_instruction_div_mem_wdata)
  );

  wire                                spec_instruction_divu_valid;
  wire                                spec_instruction_divu_trap;
  wire [                       4 : 0] spec_instruction_divu_rs1_addr;
  wire [                       4 : 0] spec_instruction_divu_rs2_addr;
  wire [                       4 : 0] spec_instruction_divu_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_divu_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_divu_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_divu_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_divu_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_divu_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_divu_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_divu_csr_misa_rmask;
`endif

  rvfi_instruction_divu divu (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_divu_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_divu_valid),
    .spec_trap(spec_instruction_divu_trap),
    .spec_rs1_addr(spec_instruction_divu_rs1_addr),
    .spec_rs2_addr(spec_instruction_divu_rs2_addr),
    .spec_rd_addr(spec_instruction_divu_rd_addr),
    .spec_rd_wdata(spec_instruction_divu_rd_wdata),
    .spec_pc_wdata(spec_instruction_divu_pc_wdata),
    .spec_mem_addr(spec_instruction_divu_mem_addr),
    .spec_mem_rmask(spec_instruction_divu_mem_rmask),
    .spec_mem_wmask(spec_instruction_divu_mem_wmask),
    .spec_mem_wdata(spec_instruction_divu_mem_wdata)
  );

  wire                                spec_instruction_divuw_valid;
  wire                                spec_instruction_divuw_trap;
  wire [                       4 : 0] spec_instruction_divuw_rs1_addr;
  wire [                       4 : 0] spec_instruction_divuw_rs2_addr;
  wire [                       4 : 0] spec_instruction_divuw_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_divuw_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_divuw_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_divuw_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_divuw_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_divuw_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_divuw_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_divuw_csr_misa_rmask;
`endif

  rvfi_instruction_divuw divuw (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_divuw_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_divuw_valid),
    .spec_trap(spec_instruction_divuw_trap),
    .spec_rs1_addr(spec_instruction_divuw_rs1_addr),
    .spec_rs2_addr(spec_instruction_divuw_rs2_addr),
    .spec_rd_addr(spec_instruction_divuw_rd_addr),
    .spec_rd_wdata(spec_instruction_divuw_rd_wdata),
    .spec_pc_wdata(spec_instruction_divuw_pc_wdata),
    .spec_mem_addr(spec_instruction_divuw_mem_addr),
    .spec_mem_rmask(spec_instruction_divuw_mem_rmask),
    .spec_mem_wmask(spec_instruction_divuw_mem_wmask),
    .spec_mem_wdata(spec_instruction_divuw_mem_wdata)
  );

  wire                                spec_instruction_divw_valid;
  wire                                spec_instruction_divw_trap;
  wire [                       4 : 0] spec_instruction_divw_rs1_addr;
  wire [                       4 : 0] spec_instruction_divw_rs2_addr;
  wire [                       4 : 0] spec_instruction_divw_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_divw_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_divw_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_divw_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_divw_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_divw_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_divw_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_divw_csr_misa_rmask;
`endif

  rvfi_instruction_divw divw (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_divw_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_divw_valid),
    .spec_trap(spec_instruction_divw_trap),
    .spec_rs1_addr(spec_instruction_divw_rs1_addr),
    .spec_rs2_addr(spec_instruction_divw_rs2_addr),
    .spec_rd_addr(spec_instruction_divw_rd_addr),
    .spec_rd_wdata(spec_instruction_divw_rd_wdata),
    .spec_pc_wdata(spec_instruction_divw_pc_wdata),
    .spec_mem_addr(spec_instruction_divw_mem_addr),
    .spec_mem_rmask(spec_instruction_divw_mem_rmask),
    .spec_mem_wmask(spec_instruction_divw_mem_wmask),
    .spec_mem_wdata(spec_instruction_divw_mem_wdata)
  );
...
`endif
  ...
  wire                                spec_instruction_ld_valid;
  wire                                spec_instruction_ld_trap;
  wire [                       4 : 0] spec_instruction_ld_rs1_addr;
  wire [                       4 : 0] spec_instruction_ld_rs2_addr;
  wire [                       4 : 0] spec_instruction_ld_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_ld_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_ld_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_ld_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_ld_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_ld_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_ld_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_ld_csr_misa_rmask;
`endif

  rvfi_instruction_ld ld (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_ld_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_ld_valid),
    .spec_trap(spec_instruction_ld_trap),
    .spec_rs1_addr(spec_instruction_ld_rs1_addr),
    .spec_rs2_addr(spec_instruction_ld_rs2_addr),
    .spec_rd_addr(spec_instruction_ld_rd_addr),
    .spec_rd_wdata(spec_instruction_ld_rd_wdata),
    .spec_pc_wdata(spec_instruction_ld_pc_wdata),
    .spec_mem_addr(spec_instruction_ld_mem_addr),
    .spec_mem_rmask(spec_instruction_ld_mem_rmask),
    .spec_mem_wmask(spec_instruction_ld_mem_wmask),
    .spec_mem_wdata(spec_instruction_ld_mem_wdata)
  );
...
`endif
  ...
  wire                                spec_instruction_lwu_valid;
  wire                                spec_instruction_lwu_trap;
  wire [                       4 : 0] spec_instruction_lwu_rs1_addr;
  wire [                       4 : 0] spec_instruction_lwu_rs2_addr;
  wire [                       4 : 0] spec_instruction_lwu_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_lwu_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_lwu_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_lwu_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_lwu_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_lwu_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_lwu_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_lwu_csr_misa_rmask;
`endif

  rvfi_instruction_lwu lwu (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_lwu_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_lwu_valid),
    .spec_trap(spec_instruction_lwu_trap),
    .spec_rs1_addr(spec_instruction_lwu_rs1_addr),
    .spec_rs2_addr(spec_instruction_lwu_rs2_addr),
    .spec_rd_addr(spec_instruction_lwu_rd_addr),
    .spec_rd_wdata(spec_instruction_lwu_rd_wdata),
    .spec_pc_wdata(spec_instruction_lwu_pc_wdata),
    .spec_mem_addr(spec_instruction_lwu_mem_addr),
    .spec_mem_rmask(spec_instruction_lwu_mem_rmask),
    .spec_mem_wmask(spec_instruction_lwu_mem_wmask),
    .spec_mem_wdata(spec_instruction_lwu_mem_wdata)
  );

  wire                                spec_instruction_mul_valid;
  wire                                spec_instruction_mul_trap;
  wire [                       4 : 0] spec_instruction_mul_rs1_addr;
  wire [                       4 : 0] spec_instruction_mul_rs2_addr;
  wire [                       4 : 0] spec_instruction_mul_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_mul_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_mul_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_mul_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_mul_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_mul_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_mul_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_mul_csr_misa_rmask;
`endif

  rvfi_instruction_mul mul (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_mul_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_mul_valid),
    .spec_trap(spec_instruction_mul_trap),
    .spec_rs1_addr(spec_instruction_mul_rs1_addr),
    .spec_rs2_addr(spec_instruction_mul_rs2_addr),
    .spec_rd_addr(spec_instruction_mul_rd_addr),
    .spec_rd_wdata(spec_instruction_mul_rd_wdata),
    .spec_pc_wdata(spec_instruction_mul_pc_wdata),
    .spec_mem_addr(spec_instruction_mul_mem_addr),
    .spec_mem_rmask(spec_instruction_mul_mem_rmask),
    .spec_mem_wmask(spec_instruction_mul_mem_wmask),
    .spec_mem_wdata(spec_instruction_mul_mem_wdata)
  );

  wire                                spec_instruction_mulh_valid;
  wire                                spec_instruction_mulh_trap;
  wire [                       4 : 0] spec_instruction_mulh_rs1_addr;
  wire [                       4 : 0] spec_instruction_mulh_rs2_addr;
  wire [                       4 : 0] spec_instruction_mulh_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_mulh_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_mulh_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_mulh_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_mulh_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_mulh_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_mulh_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_mulh_csr_misa_rmask;
`endif

  rvfi_instruction_mulh mulh (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_mulh_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_mulh_valid),
    .spec_trap(spec_instruction_mulh_trap),
    .spec_rs1_addr(spec_instruction_mulh_rs1_addr),
    .spec_rs2_addr(spec_instruction_mulh_rs2_addr),
    .spec_rd_addr(spec_instruction_mulh_rd_addr),
    .spec_rd_wdata(spec_instruction_mulh_rd_wdata),
    .spec_pc_wdata(spec_instruction_mulh_pc_wdata),
    .spec_mem_addr(spec_instruction_mulh_mem_addr),
    .spec_mem_rmask(spec_instruction_mulh_mem_rmask),
    .spec_mem_wmask(spec_instruction_mulh_mem_wmask),
    .spec_mem_wdata(spec_instruction_mulh_mem_wdata)
  );

  wire                                spec_instruction_mulhsu_valid;
  wire                                spec_instruction_mulhsu_trap;
  wire [                       4 : 0] spec_instruction_mulhsu_rs1_addr;
  wire [                       4 : 0] spec_instruction_mulhsu_rs2_addr;
  wire [                       4 : 0] spec_instruction_mulhsu_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_mulhsu_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_mulhsu_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_mulhsu_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_mulhsu_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_mulhsu_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_mulhsu_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_mulhsu_csr_misa_rmask;
`endif

  rvfi_instruction_mulhsu mulhsu (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_mulhsu_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_mulhsu_valid),
    .spec_trap(spec_instruction_mulhsu_trap),
    .spec_rs1_addr(spec_instruction_mulhsu_rs1_addr),
    .spec_rs2_addr(spec_instruction_mulhsu_rs2_addr),
    .spec_rd_addr(spec_instruction_mulhsu_rd_addr),
    .spec_rd_wdata(spec_instruction_mulhsu_rd_wdata),
    .spec_pc_wdata(spec_instruction_mulhsu_pc_wdata),
    .spec_mem_addr(spec_instruction_mulhsu_mem_addr),
    .spec_mem_rmask(spec_instruction_mulhsu_mem_rmask),
    .spec_mem_wmask(spec_instruction_mulhsu_mem_wmask),
    .spec_mem_wdata(spec_instruction_mulhsu_mem_wdata)
  );

  wire                                spec_instruction_mulhu_valid;
  wire                                spec_instruction_mulhu_trap;
  wire [                       4 : 0] spec_instruction_mulhu_rs1_addr;
  wire [                       4 : 0] spec_instruction_mulhu_rs2_addr;
  wire [                       4 : 0] spec_instruction_mulhu_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_mulhu_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_mulhu_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_mulhu_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_mulhu_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_mulhu_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_mulhu_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_mulhu_csr_misa_rmask;
`endif

  rvfi_instruction_mulhu mulhu (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_mulhu_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_mulhu_valid),
    .spec_trap(spec_instruction_mulhu_trap),
    .spec_rs1_addr(spec_instruction_mulhu_rs1_addr),
    .spec_rs2_addr(spec_instruction_mulhu_rs2_addr),
    .spec_rd_addr(spec_instruction_mulhu_rd_addr),
    .spec_rd_wdata(spec_instruction_mulhu_rd_wdata),
    .spec_pc_wdata(spec_instruction_mulhu_pc_wdata),
    .spec_mem_addr(spec_instruction_mulhu_mem_addr),
    .spec_mem_rmask(spec_instruction_mulhu_mem_rmask),
    .spec_mem_wmask(spec_instruction_mulhu_mem_wmask),
    .spec_mem_wdata(spec_instruction_mulhu_mem_wdata)
  );

  wire                                spec_instruction_mulw_valid;
  wire                                spec_instruction_mulw_trap;
  wire [                       4 : 0] spec_instruction_mulw_rs1_addr;
  wire [                       4 : 0] spec_instruction_mulw_rs2_addr;
  wire [                       4 : 0] spec_instruction_mulw_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_mulw_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_mulw_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_mulw_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_mulw_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_mulw_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_mulw_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_mulw_csr_misa_rmask;
`endif

  rvfi_instruction_mulw mulw (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_mulw_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_mulw_valid),
    .spec_trap(spec_instruction_mulw_trap),
    .spec_rs1_addr(spec_instruction_mulw_rs1_addr),
    .spec_rs2_addr(spec_instruction_mulw_rs2_addr),
    .spec_rd_addr(spec_instruction_mulw_rd_addr),
    .spec_rd_wdata(spec_instruction_mulw_rd_wdata),
    .spec_pc_wdata(spec_instruction_mulw_pc_wdata),
    .spec_mem_addr(spec_instruction_mulw_mem_addr),
    .spec_mem_rmask(spec_instruction_mulw_mem_rmask),
    .spec_mem_wmask(spec_instruction_mulw_mem_wmask),
    .spec_mem_wdata(spec_instruction_mulw_mem_wdata)
  );
...
`endif
  ...
  wire                                spec_instruction_rem_valid;
  wire                                spec_instruction_rem_trap;
  wire [                       4 : 0] spec_instruction_rem_rs1_addr;
  wire [                       4 : 0] spec_instruction_rem_rs2_addr;
  wire [                       4 : 0] spec_instruction_rem_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_rem_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_rem_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_rem_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_rem_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_rem_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_rem_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_rem_csr_misa_rmask;
`endif

  rvfi_instruction_rem rem (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_rem_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_rem_valid),
    .spec_trap(spec_instruction_rem_trap),
    .spec_rs1_addr(spec_instruction_rem_rs1_addr),
    .spec_rs2_addr(spec_instruction_rem_rs2_addr),
    .spec_rd_addr(spec_instruction_rem_rd_addr),
    .spec_rd_wdata(spec_instruction_rem_rd_wdata),
    .spec_pc_wdata(spec_instruction_rem_pc_wdata),
    .spec_mem_addr(spec_instruction_rem_mem_addr),
    .spec_mem_rmask(spec_instruction_rem_mem_rmask),
    .spec_mem_wmask(spec_instruction_rem_mem_wmask),
    .spec_mem_wdata(spec_instruction_rem_mem_wdata)
  );

  wire                                spec_instruction_remu_valid;
  wire                                spec_instruction_remu_trap;
  wire [                       4 : 0] spec_instruction_remu_rs1_addr;
  wire [                       4 : 0] spec_instruction_remu_rs2_addr;
  wire [                       4 : 0] spec_instruction_remu_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_remu_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_remu_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_remu_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_remu_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_remu_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_remu_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_remu_csr_misa_rmask;
`endif

  rvfi_instruction_remu remu (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_remu_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_remu_valid),
    .spec_trap(spec_instruction_remu_trap),
    .spec_rs1_addr(spec_instruction_remu_rs1_addr),
    .spec_rs2_addr(spec_instruction_remu_rs2_addr),
    .spec_rd_addr(spec_instruction_remu_rd_addr),
    .spec_rd_wdata(spec_instruction_remu_rd_wdata),
    .spec_pc_wdata(spec_instruction_remu_pc_wdata),
    .spec_mem_addr(spec_instruction_remu_mem_addr),
    .spec_mem_rmask(spec_instruction_remu_mem_rmask),
    .spec_mem_wmask(spec_instruction_remu_mem_wmask),
    .spec_mem_wdata(spec_instruction_remu_mem_wdata)
  );

  wire                                spec_instruction_remuw_valid;
  wire                                spec_instruction_remuw_trap;
  wire [                       4 : 0] spec_instruction_remuw_rs1_addr;
  wire [                       4 : 0] spec_instruction_remuw_rs2_addr;
  wire [                       4 : 0] spec_instruction_remuw_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_remuw_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_remuw_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_remuw_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_remuw_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_remuw_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_remuw_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_remuw_csr_misa_rmask;
`endif

  rvfi_instruction_remuw remuw (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_remuw_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_remuw_valid),
    .spec_trap(spec_instruction_remuw_trap),
    .spec_rs1_addr(spec_instruction_remuw_rs1_addr),
    .spec_rs2_addr(spec_instruction_remuw_rs2_addr),
    .spec_rd_addr(spec_instruction_remuw_rd_addr),
    .spec_rd_wdata(spec_instruction_remuw_rd_wdata),
    .spec_pc_wdata(spec_instruction_remuw_pc_wdata),
    .spec_mem_addr(spec_instruction_remuw_mem_addr),
    .spec_mem_rmask(spec_instruction_remuw_mem_rmask),
    .spec_mem_wmask(spec_instruction_remuw_mem_wmask),
    .spec_mem_wdata(spec_instruction_remuw_mem_wdata)
  );

  wire                                spec_instruction_remw_valid;
  wire                                spec_instruction_remw_trap;
  wire [                       4 : 0] spec_instruction_remw_rs1_addr;
  wire [                       4 : 0] spec_instruction_remw_rs2_addr;
  wire [                       4 : 0] spec_instruction_remw_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_remw_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_remw_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_remw_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_remw_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_remw_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_remw_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_remw_csr_misa_rmask;
`endif

  rvfi_instruction_remw remw (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_remw_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_remw_valid),
    .spec_trap(spec_instruction_remw_trap),
    .spec_rs1_addr(spec_instruction_remw_rs1_addr),
    .spec_rs2_addr(spec_instruction_remw_rs2_addr),
    .spec_rd_addr(spec_instruction_remw_rd_addr),
    .spec_rd_wdata(spec_instruction_remw_rd_wdata),
    .spec_pc_wdata(spec_instruction_remw_pc_wdata),
    .spec_mem_addr(spec_instruction_remw_mem_addr),
    .spec_mem_rmask(spec_instruction_remw_mem_rmask),
    .spec_mem_wmask(spec_instruction_remw_mem_wmask),
    .spec_mem_wdata(spec_instruction_remw_mem_wdata)
  );
...
`endif
  ...
  wire                                spec_instruction_sd_valid;
  wire                                spec_instruction_sd_trap;
  wire [                       4 : 0] spec_instruction_sd_rs1_addr;
  wire [                       4 : 0] spec_instruction_sd_rs2_addr;
  wire [                       4 : 0] spec_instruction_sd_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_sd_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_sd_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_sd_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_sd_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_sd_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_sd_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_sd_csr_misa_rmask;
`endif

  rvfi_instruction_sd sd (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_sd_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_sd_valid),
    .spec_trap(spec_instruction_sd_trap),
    .spec_rs1_addr(spec_instruction_sd_rs1_addr),
    .spec_rs2_addr(spec_instruction_sd_rs2_addr),
    .spec_rd_addr(spec_instruction_sd_rd_addr),
    .spec_rd_wdata(spec_instruction_sd_rd_wdata),
    .spec_pc_wdata(spec_instruction_sd_pc_wdata),
    .spec_mem_addr(spec_instruction_sd_mem_addr),
    .spec_mem_rmask(spec_instruction_sd_mem_rmask),
    .spec_mem_wmask(spec_instruction_sd_mem_wmask),
    .spec_mem_wdata(spec_instruction_sd_mem_wdata)
  );
...
`endif
  ...
  wire                                spec_instruction_slliw_valid;
  wire                                spec_instruction_slliw_trap;
  wire [                       4 : 0] spec_instruction_slliw_rs1_addr;
  wire [                       4 : 0] spec_instruction_slliw_rs2_addr;
  wire [                       4 : 0] spec_instruction_slliw_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_slliw_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_slliw_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_slliw_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_slliw_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_slliw_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_slliw_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_slliw_csr_misa_rmask;
`endif

  rvfi_instruction_slliw slliw (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_slliw_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_slliw_valid),
    .spec_trap(spec_instruction_slliw_trap),
    .spec_rs1_addr(spec_instruction_slliw_rs1_addr),
    .spec_rs2_addr(spec_instruction_slliw_rs2_addr),
    .spec_rd_addr(spec_instruction_slliw_rd_addr),
    .spec_rd_wdata(spec_instruction_slliw_rd_wdata),
    .spec_pc_wdata(spec_instruction_slliw_pc_wdata),
    .spec_mem_addr(spec_instruction_slliw_mem_addr),
    .spec_mem_rmask(spec_instruction_slliw_mem_rmask),
    .spec_mem_wmask(spec_instruction_slliw_mem_wmask),
    .spec_mem_wdata(spec_instruction_slliw_mem_wdata)
  );

  wire                                spec_instruction_sllw_valid;
  wire                                spec_instruction_sllw_trap;
  wire [                       4 : 0] spec_instruction_sllw_rs1_addr;
  wire [                       4 : 0] spec_instruction_sllw_rs2_addr;
  wire [                       4 : 0] spec_instruction_sllw_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_sllw_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_sllw_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_sllw_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_sllw_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_sllw_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_sllw_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_sllw_csr_misa_rmask;
`endif

  rvfi_instruction_sllw sllw (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_sllw_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_sllw_valid),
    .spec_trap(spec_instruction_sllw_trap),
    .spec_rs1_addr(spec_instruction_sllw_rs1_addr),
    .spec_rs2_addr(spec_instruction_sllw_rs2_addr),
    .spec_rd_addr(spec_instruction_sllw_rd_addr),
    .spec_rd_wdata(spec_instruction_sllw_rd_wdata),
    .spec_pc_wdata(spec_instruction_sllw_pc_wdata),
    .spec_mem_addr(spec_instruction_sllw_mem_addr),
    .spec_mem_rmask(spec_instruction_sllw_mem_rmask),
    .spec_mem_wmask(spec_instruction_sllw_mem_wmask),
    .spec_mem_wdata(spec_instruction_sllw_mem_wdata)
  );
...
`endif
  ...
  wire                                spec_instruction_sraiw_valid;
  wire                                spec_instruction_sraiw_trap;
  wire [                       4 : 0] spec_instruction_sraiw_rs1_addr;
  wire [                       4 : 0] spec_instruction_sraiw_rs2_addr;
  wire [                       4 : 0] spec_instruction_sraiw_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_sraiw_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_sraiw_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_sraiw_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_sraiw_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_sraiw_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_sraiw_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_sraiw_csr_misa_rmask;
`endif

  rvfi_instruction_sraiw sraiw (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_sraiw_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_sraiw_valid),
    .spec_trap(spec_instruction_sraiw_trap),
    .spec_rs1_addr(spec_instruction_sraiw_rs1_addr),
    .spec_rs2_addr(spec_instruction_sraiw_rs2_addr),
    .spec_rd_addr(spec_instruction_sraiw_rd_addr),
    .spec_rd_wdata(spec_instruction_sraiw_rd_wdata),
    .spec_pc_wdata(spec_instruction_sraiw_pc_wdata),
    .spec_mem_addr(spec_instruction_sraiw_mem_addr),
    .spec_mem_rmask(spec_instruction_sraiw_mem_rmask),
    .spec_mem_wmask(spec_instruction_sraiw_mem_wmask),
    .spec_mem_wdata(spec_instruction_sraiw_mem_wdata)
  );

  wire                                spec_instruction_sraw_valid;
  wire                                spec_instruction_sraw_trap;
  wire [                       4 : 0] spec_instruction_sraw_rs1_addr;
  wire [                       4 : 0] spec_instruction_sraw_rs2_addr;
  wire [                       4 : 0] spec_instruction_sraw_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_sraw_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_sraw_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_sraw_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_sraw_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_sraw_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_sraw_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_sraw_csr_misa_rmask;
`endif

  rvfi_instruction_sraw sraw (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_sraw_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_sraw_valid),
    .spec_trap(spec_instruction_sraw_trap),
    .spec_rs1_addr(spec_instruction_sraw_rs1_addr),
    .spec_rs2_addr(spec_instruction_sraw_rs2_addr),
    .spec_rd_addr(spec_instruction_sraw_rd_addr),
    .spec_rd_wdata(spec_instruction_sraw_rd_wdata),
    .spec_pc_wdata(spec_instruction_sraw_pc_wdata),
    .spec_mem_addr(spec_instruction_sraw_mem_addr),
    .spec_mem_rmask(spec_instruction_sraw_mem_rmask),
    .spec_mem_wmask(spec_instruction_sraw_mem_wmask),
    .spec_mem_wdata(spec_instruction_sraw_mem_wdata)
  );
...
`endif
  ...
  wire                                spec_instruction_srliw_valid;
  wire                                spec_instruction_srliw_trap;
  wire [                       4 : 0] spec_instruction_srliw_rs1_addr;
  wire [                       4 : 0] spec_instruction_srliw_rs2_addr;
  wire [                       4 : 0] spec_instruction_srliw_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_srliw_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_srliw_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_srliw_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_srliw_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_srliw_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_srliw_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_srliw_csr_misa_rmask;
`endif

  rvfi_instruction_srliw srliw (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_srliw_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_srliw_valid),
    .spec_trap(spec_instruction_srliw_trap),
    .spec_rs1_addr(spec_instruction_srliw_rs1_addr),
    .spec_rs2_addr(spec_instruction_srliw_rs2_addr),
    .spec_rd_addr(spec_instruction_srliw_rd_addr),
    .spec_rd_wdata(spec_instruction_srliw_rd_wdata),
    .spec_pc_wdata(spec_instruction_srliw_pc_wdata),
    .spec_mem_addr(spec_instruction_srliw_mem_addr),
    .spec_mem_rmask(spec_instruction_srliw_mem_rmask),
    .spec_mem_wmask(spec_instruction_srliw_mem_wmask),
    .spec_mem_wdata(spec_instruction_srliw_mem_wdata)
  );

  wire                                spec_instruction_srlw_valid;
  wire                                spec_instruction_srlw_trap;
  wire [                       4 : 0] spec_instruction_srlw_rs1_addr;
  wire [                       4 : 0] spec_instruction_srlw_rs2_addr;
  wire [                       4 : 0] spec_instruction_srlw_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_srlw_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_srlw_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_srlw_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_srlw_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_srlw_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_srlw_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_srlw_csr_misa_rmask;
`endif

  rvfi_instruction_srlw srlw (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_srlw_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_srlw_valid),
    .spec_trap(spec_instruction_srlw_trap),
    .spec_rs1_addr(spec_instruction_srlw_rs1_addr),
    .spec_rs2_addr(spec_instruction_srlw_rs2_addr),
    .spec_rd_addr(spec_instruction_srlw_rd_addr),
    .spec_rd_wdata(spec_instruction_srlw_rd_wdata),
    .spec_pc_wdata(spec_instruction_srlw_pc_wdata),
    .spec_mem_addr(spec_instruction_srlw_mem_addr),
    .spec_mem_rmask(spec_instruction_srlw_mem_rmask),
    .spec_mem_wmask(spec_instruction_srlw_mem_wmask),
    .spec_mem_wdata(spec_instruction_srlw_mem_wdata)
  );
...
`endif
  ...
  wire                                spec_instruction_subw_valid;
  wire                                spec_instruction_subw_trap;
  wire [                       4 : 0] spec_instruction_subw_rs1_addr;
  wire [                       4 : 0] spec_instruction_subw_rs2_addr;
  wire [                       4 : 0] spec_instruction_subw_rd_addr;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_subw_rd_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_subw_pc_wdata;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_subw_mem_addr;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_subw_mem_rmask;
  wire [`RISCV_FORMAL_XLEN/8 - 1 : 0] spec_instruction_subw_mem_wmask;
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_subw_mem_wdata;
`ifdef RISCV_FORMAL_CSR_MISA
  wire [`RISCV_FORMAL_XLEN   - 1 : 0] spec_instruction_subw_csr_misa_rmask;
`endif

  rvfi_instruction_subw subw (
    .rvfi_valid(rvfi_valid),
    .rvfi_instruction(rvfi_instruction),
    .rvfi_pc_rdata(rvfi_pc_rdata),
    .rvfi_rs1_rdata(rvfi_rs1_rdata),
...
`ifdef RISCV_FORMAL_CSR_MISA
    .rvfi_csr_misa_rdata(rvfi_csr_misa_rdata),
    .spec_csr_misa_rmask(spec_instruction_subw_csr_misa_rmask),
`endif
    .spec_valid(spec_instruction_subw_valid),
    .spec_trap(spec_instruction_subw_trap),
    .spec_rs1_addr(spec_instruction_subw_rs1_addr),
    .spec_rs2_addr(spec_instruction_subw_rs2_addr),
    .spec_rd_addr(spec_instruction_subw_rd_addr),
    .spec_rd_wdata(spec_instruction_subw_rd_wdata),
    .spec_pc_wdata(spec_instruction_subw_pc_wdata),
    .spec_mem_addr(spec_instruction_subw_mem_addr),
    .spec_mem_rmask(spec_instruction_subw_mem_rmask),
    .spec_mem_wmask(spec_instruction_subw_mem_wmask),
    .spec_mem_wdata(spec_instruction_subw_mem_wdata)
  );
...
`endif
  ...
  assign spec_valid =
		...
		spec_instruction_addiw_valid ? spec_instruction_addiw_valid :
		spec_instruction_addw_valid ? spec_instruction_addw_valid :
		...
		spec_instruction_c_addiw_valid ? spec_instruction_c_addiw_valid :
		spec_instruction_c_addw_valid ? spec_instruction_c_addw_valid :
		...
		spec_instruction_c_ld_valid ? spec_instruction_c_ld_valid :
		spec_instruction_c_ldsp_valid ? spec_instruction_c_ldsp_valid :
		...
		spec_instruction_c_sd_valid ? spec_instruction_c_sd_valid :
		spec_instruction_c_sdsp_valid ? spec_instruction_c_sdsp_valid :
		...
		spec_instruction_c_subw_valid ? spec_instruction_c_subw_valid :
		...
		spec_instruction_div_valid ? spec_instruction_div_valid :
		spec_instruction_divu_valid ? spec_instruction_divu_valid :
		spec_instruction_divuw_valid ? spec_instruction_divuw_valid :
		spec_instruction_divw_valid ? spec_instruction_divw_valid :
		...
		spec_instruction_ld_valid ? spec_instruction_ld_valid :
		...
		spec_instruction_lwu_valid ? spec_instruction_lwu_valid :
		spec_instruction_mul_valid ? spec_instruction_mul_valid :
		spec_instruction_mulh_valid ? spec_instruction_mulh_valid :
		spec_instruction_mulhsu_valid ? spec_instruction_mulhsu_valid :
		spec_instruction_mulhu_valid ? spec_instruction_mulhu_valid :
		spec_instruction_mulw_valid ? spec_instruction_mulw_valid :
		spec_instruction_or_valid ? spec_instruction_or_valid :
		spec_instruction_ori_valid ? spec_instruction_ori_valid :
		spec_instruction_rem_valid ? spec_instruction_rem_valid :
		spec_instruction_remu_valid ? spec_instruction_remu_valid :
		spec_instruction_remuw_valid ? spec_instruction_remuw_valid :
		spec_instruction_remw_valid ? spec_instruction_remw_valid :
		spec_instruction_sb_valid ? spec_instruction_sb_valid :
		spec_instruction_sd_valid ? spec_instruction_sd_valid :
		...
		spec_instruction_slliw_valid ? spec_instruction_slliw_valid :
		spec_instruction_sllw_valid ? spec_instruction_sllw_valid :
		...
		spec_instruction_sraiw_valid ? spec_instruction_sraiw_valid :
		spec_instruction_sraw_valid ? spec_instruction_sraw_valid :
		spec_instruction_srl_valid ? spec_instruction_srl_valid :
		spec_instruction_srli_valid ? spec_instruction_srli_valid :
		spec_instruction_srliw_valid ? spec_instruction_srliw_valid :
		spec_instruction_srlw_valid ? spec_instruction_srlw_valid :
		spec_instruction_sub_valid ? spec_instruction_sub_valid :
		spec_instruction_subw_valid ? spec_instruction_subw_valid :
  ...
  assign spec_trap =
		...
		spec_instruction_addiw_valid ? spec_instruction_addiw_trap :
		spec_instruction_addw_valid ? spec_instruction_addw_trap :
		...
		spec_instruction_c_addiw_valid ? spec_instruction_c_addiw_trap :
		spec_instruction_c_addw_valid ? spec_instruction_c_addw_trap :
		...
		spec_instruction_c_ld_valid ? spec_instruction_c_ld_trap :
		spec_instruction_c_ldsp_valid ? spec_instruction_c_ldsp_trap :
		...
		spec_instruction_c_sd_valid ? spec_instruction_c_sd_trap :
		spec_instruction_c_sdsp_valid ? spec_instruction_c_sdsp_trap :
		...
		spec_instruction_c_subw_valid ? spec_instruction_c_subw_trap :
		...
		spec_instruction_div_valid ? spec_instruction_div_trap :
		spec_instruction_divu_valid ? spec_instruction_divu_trap :
		spec_instruction_divuw_valid ? spec_instruction_divuw_trap :
		spec_instruction_divw_valid ? spec_instruction_divw_trap :
		...
		spec_instruction_ld_valid ? spec_instruction_ld_trap :
		...
		spec_instruction_lwu_valid ? spec_instruction_lwu_trap :
		spec_instruction_mul_valid ? spec_instruction_mul_trap :
		spec_instruction_mulh_valid ? spec_instruction_mulh_trap :
		spec_instruction_mulhsu_valid ? spec_instruction_mulhsu_trap :
		spec_instruction_mulhu_valid ? spec_instruction_mulhu_trap :
		spec_instruction_mulw_valid ? spec_instruction_mulw_trap :
		spec_instruction_or_valid ? spec_instruction_or_trap :
		spec_instruction_ori_valid ? spec_instruction_ori_trap :
		spec_instruction_rem_valid ? spec_instruction_rem_trap :
		spec_instruction_remu_valid ? spec_instruction_remu_trap :
		spec_instruction_remuw_valid ? spec_instruction_remuw_trap :
		spec_instruction_remw_valid ? spec_instruction_remw_trap :
		spec_instruction_sb_valid ? spec_instruction_sb_trap :
		spec_instruction_sd_valid ? spec_instruction_sd_trap :
		...
		spec_instruction_slliw_valid ? spec_instruction_slliw_trap :
		spec_instruction_sllw_valid ? spec_instruction_sllw_trap :
		...
		spec_instruction_sraiw_valid ? spec_instruction_sraiw_trap :
		spec_instruction_sraw_valid ? spec_instruction_sraw_trap :
		spec_instruction_srl_valid ? spec_instruction_srl_trap :
		spec_instruction_srli_valid ? spec_instruction_srli_trap :
		spec_instruction_srliw_valid ? spec_instruction_srliw_trap :
		spec_instruction_srlw_valid ? spec_instruction_srlw_trap :
		spec_instruction_sub_valid ? spec_instruction_sub_trap :
		spec_instruction_subw_valid ? spec_instruction_subw_trap :
  ...
  assign spec_rs1_addr =
		...
		spec_instruction_addiw_valid ? spec_instruction_addiw_rs1_addr :
		spec_instruction_addw_valid ? spec_instruction_addw_rs1_addr :
		...
		spec_instruction_c_addiw_valid ? spec_instruction_c_addiw_rs1_addr :
		spec_instruction_c_addw_valid ? spec_instruction_c_addw_rs1_addr :
		...
		spec_instruction_c_ld_valid ? spec_instruction_c_ld_rs1_addr :
		spec_instruction_c_ldsp_valid ? spec_instruction_c_ldsp_rs1_addr :
		...
		spec_instruction_c_sd_valid ? spec_instruction_c_sd_rs1_addr :
		spec_instruction_c_sdsp_valid ? spec_instruction_c_sdsp_rs1_addr :
		...
		spec_instruction_c_subw_valid ? spec_instruction_c_subw_rs1_addr :
		...
		spec_instruction_div_valid ? spec_instruction_div_rs1_addr :
		spec_instruction_divu_valid ? spec_instruction_divu_rs1_addr :
		spec_instruction_divuw_valid ? spec_instruction_divuw_rs1_addr :
		spec_instruction_divw_valid ? spec_instruction_divw_rs1_addr :
		...
		spec_instruction_ld_valid ? spec_instruction_ld_rs1_addr :
		...
		spec_instruction_lwu_valid ? spec_instruction_lwu_rs1_addr :
		spec_instruction_mul_valid ? spec_instruction_mul_rs1_addr :
		spec_instruction_mulh_valid ? spec_instruction_mulh_rs1_addr :
		spec_instruction_mulhsu_valid ? spec_instruction_mulhsu_rs1_addr :
		spec_instruction_mulhu_valid ? spec_instruction_mulhu_rs1_addr :
		spec_instruction_mulw_valid ? spec_instruction_mulw_rs1_addr :
		spec_instruction_or_valid ? spec_instruction_or_rs1_addr :
		spec_instruction_ori_valid ? spec_instruction_ori_rs1_addr :
		spec_instruction_rem_valid ? spec_instruction_rem_rs1_addr :
		spec_instruction_remu_valid ? spec_instruction_remu_rs1_addr :
		spec_instruction_remuw_valid ? spec_instruction_remuw_rs1_addr :
		spec_instruction_remw_valid ? spec_instruction_remw_rs1_addr :
		spec_instruction_sb_valid ? spec_instruction_sb_rs1_addr :
		spec_instruction_sd_valid ? spec_instruction_sd_rs1_addr :
		...
		spec_instruction_slliw_valid ? spec_instruction_slliw_rs1_addr :
		spec_instruction_sllw_valid ? spec_instruction_sllw_rs1_addr :
		...
		spec_instruction_sraiw_valid ? spec_instruction_sraiw_rs1_addr :
		spec_instruction_sraw_valid ? spec_instruction_sraw_rs1_addr :
		spec_instruction_srl_valid ? spec_instruction_srl_rs1_addr :
		spec_instruction_srli_valid ? spec_instruction_srli_rs1_addr :
		spec_instruction_srliw_valid ? spec_instruction_srliw_rs1_addr :
		spec_instruction_srlw_valid ? spec_instruction_srlw_rs1_addr :
		spec_instruction_sub_valid ? spec_instruction_sub_rs1_addr :
		spec_instruction_subw_valid ? spec_instruction_subw_rs1_addr :
  ...
  assign spec_rs2_addr =
		...
		spec_instruction_addiw_valid ? spec_instruction_addiw_rs2_addr :
		spec_instruction_addw_valid ? spec_instruction_addw_rs2_addr :
		...
		spec_instruction_c_addiw_valid ? spec_instruction_c_addiw_rs2_addr :
		spec_instruction_c_addw_valid ? spec_instruction_c_addw_rs2_addr :
		...
		spec_instruction_c_ld_valid ? spec_instruction_c_ld_rs2_addr :
		spec_instruction_c_ldsp_valid ? spec_instruction_c_ldsp_rs2_addr :
		...
		spec_instruction_c_sd_valid ? spec_instruction_c_sd_rs2_addr :
		spec_instruction_c_sdsp_valid ? spec_instruction_c_sdsp_rs2_addr :
		...
		spec_instruction_c_subw_valid ? spec_instruction_c_subw_rs2_addr :
		...
		spec_instruction_div_valid ? spec_instruction_div_rs2_addr :
		spec_instruction_divu_valid ? spec_instruction_divu_rs2_addr :
		spec_instruction_divuw_valid ? spec_instruction_divuw_rs2_addr :
		spec_instruction_divw_valid ? spec_instruction_divw_rs2_addr :
		...
		spec_instruction_ld_valid ? spec_instruction_ld_rs2_addr :
		...
		spec_instruction_lwu_valid ? spec_instruction_lwu_rs2_addr :
		spec_instruction_mul_valid ? spec_instruction_mul_rs2_addr :
		spec_instruction_mulh_valid ? spec_instruction_mulh_rs2_addr :
		spec_instruction_mulhsu_valid ? spec_instruction_mulhsu_rs2_addr :
		spec_instruction_mulhu_valid ? spec_instruction_mulhu_rs2_addr :
		spec_instruction_mulw_valid ? spec_instruction_mulw_rs2_addr :
		spec_instruction_or_valid ? spec_instruction_or_rs2_addr :
		spec_instruction_ori_valid ? spec_instruction_ori_rs2_addr :
		spec_instruction_rem_valid ? spec_instruction_rem_rs2_addr :
		spec_instruction_remu_valid ? spec_instruction_remu_rs2_addr :
		spec_instruction_remuw_valid ? spec_instruction_remuw_rs2_addr :
		spec_instruction_remw_valid ? spec_instruction_remw_rs2_addr :
		spec_instruction_sb_valid ? spec_instruction_sb_rs2_addr :
		spec_instruction_sd_valid ? spec_instruction_sd_rs2_addr :
		...
		spec_instruction_slliw_valid ? spec_instruction_slliw_rs2_addr :
		spec_instruction_sllw_valid ? spec_instruction_sllw_rs2_addr :
		...
		spec_instruction_sraiw_valid ? spec_instruction_sraiw_rs2_addr :
		spec_instruction_sraw_valid ? spec_instruction_sraw_rs2_addr :
		spec_instruction_srl_valid ? spec_instruction_srl_rs2_addr :
		spec_instruction_srli_valid ? spec_instruction_srli_rs2_addr :
		spec_instruction_srliw_valid ? spec_instruction_srliw_rs2_addr :
		spec_instruction_srlw_valid ? spec_instruction_srlw_rs2_addr :
		spec_instruction_sub_valid ? spec_instruction_sub_rs2_addr :
		spec_instruction_subw_valid ? spec_instruction_subw_rs2_addr :
  ...
  assign spec_rd_addr =
		...
		spec_instruction_addiw_valid ? spec_instruction_addiw_rd_addr :
		spec_instruction_addw_valid ? spec_instruction_addw_rd_addr :
		...
		spec_instruction_c_addiw_valid ? spec_instruction_c_addiw_rd_addr :
		spec_instruction_c_addw_valid ? spec_instruction_c_addw_rd_addr :
		...
		spec_instruction_c_ld_valid ? spec_instruction_c_ld_rd_addr :
		spec_instruction_c_ldsp_valid ? spec_instruction_c_ldsp_rd_addr :
		...
		spec_instruction_c_sd_valid ? spec_instruction_c_sd_rd_addr :
		spec_instruction_c_sdsp_valid ? spec_instruction_c_sdsp_rd_addr :
		...
		spec_instruction_c_subw_valid ? spec_instruction_c_subw_rd_addr :
		...
		spec_instruction_div_valid ? spec_instruction_div_rd_addr :
		spec_instruction_divu_valid ? spec_instruction_divu_rd_addr :
		spec_instruction_divuw_valid ? spec_instruction_divuw_rd_addr :
		spec_instruction_divw_valid ? spec_instruction_divw_rd_addr :
		...
		spec_instruction_ld_valid ? spec_instruction_ld_rd_addr :
		...
		spec_instruction_lwu_valid ? spec_instruction_lwu_rd_addr :
		spec_instruction_mul_valid ? spec_instruction_mul_rd_addr :
		spec_instruction_mulh_valid ? spec_instruction_mulh_rd_addr :
		spec_instruction_mulhsu_valid ? spec_instruction_mulhsu_rd_addr :
		spec_instruction_mulhu_valid ? spec_instruction_mulhu_rd_addr :
		spec_instruction_mulw_valid ? spec_instruction_mulw_rd_addr :
		spec_instruction_or_valid ? spec_instruction_or_rd_addr :
		spec_instruction_ori_valid ? spec_instruction_ori_rd_addr :
		spec_instruction_rem_valid ? spec_instruction_rem_rd_addr :
		spec_instruction_remu_valid ? spec_instruction_remu_rd_addr :
		spec_instruction_remuw_valid ? spec_instruction_remuw_rd_addr :
		spec_instruction_remw_valid ? spec_instruction_remw_rd_addr :
		spec_instruction_sb_valid ? spec_instruction_sb_rd_addr :
		spec_instruction_sd_valid ? spec_instruction_sd_rd_addr :
		...
		spec_instruction_slliw_valid ? spec_instruction_slliw_rd_addr :
		spec_instruction_sllw_valid ? spec_instruction_sllw_rd_addr :
		...
		spec_instruction_sraiw_valid ? spec_instruction_sraiw_rd_addr :
		spec_instruction_sraw_valid ? spec_instruction_sraw_rd_addr :
		spec_instruction_srl_valid ? spec_instruction_srl_rd_addr :
		spec_instruction_srli_valid ? spec_instruction_srli_rd_addr :
		spec_instruction_srliw_valid ? spec_instruction_srliw_rd_addr :
		spec_instruction_srlw_valid ? spec_instruction_srlw_rd_addr :
		spec_instruction_sub_valid ? spec_instruction_sub_rd_addr :
		spec_instruction_subw_valid ? spec_instruction_subw_rd_addr :
  ...
  assign spec_rd_wdata =
		...
		spec_instruction_addiw_valid ? spec_instruction_addiw_rd_wdata :
		spec_instruction_addw_valid ? spec_instruction_addw_rd_wdata :
		...
		spec_instruction_c_addiw_valid ? spec_instruction_c_addiw_rd_wdata :
		spec_instruction_c_addw_valid ? spec_instruction_c_addw_rd_wdata :
		...
		spec_instruction_c_ld_valid ? spec_instruction_c_ld_rd_wdata :
		spec_instruction_c_ldsp_valid ? spec_instruction_c_ldsp_rd_wdata :
		...
		spec_instruction_c_sd_valid ? spec_instruction_c_sd_rd_wdata :
		spec_instruction_c_sdsp_valid ? spec_instruction_c_sdsp_rd_wdata :
		...
		spec_instruction_c_subw_valid ? spec_instruction_c_subw_rd_wdata :
		...
		spec_instruction_div_valid ? spec_instruction_div_rd_wdata :
		spec_instruction_divu_valid ? spec_instruction_divu_rd_wdata :
		spec_instruction_divuw_valid ? spec_instruction_divuw_rd_wdata :
		spec_instruction_divw_valid ? spec_instruction_divw_rd_wdata :
		...
		spec_instruction_ld_valid ? spec_instruction_ld_rd_wdata :
		...
		spec_instruction_lwu_valid ? spec_instruction_lwu_rd_wdata :
		spec_instruction_mul_valid ? spec_instruction_mul_rd_wdata :
		spec_instruction_mulh_valid ? spec_instruction_mulh_rd_wdata :
		spec_instruction_mulhsu_valid ? spec_instruction_mulhsu_rd_wdata :
		spec_instruction_mulhu_valid ? spec_instruction_mulhu_rd_wdata :
		spec_instruction_mulw_valid ? spec_instruction_mulw_rd_wdata :
		spec_instruction_or_valid ? spec_instruction_or_rd_wdata :
		spec_instruction_ori_valid ? spec_instruction_ori_rd_wdata :
		spec_instruction_rem_valid ? spec_instruction_rem_rd_wdata :
		spec_instruction_remu_valid ? spec_instruction_remu_rd_wdata :
		spec_instruction_remuw_valid ? spec_instruction_remuw_rd_wdata :
		spec_instruction_remw_valid ? spec_instruction_remw_rd_wdata :
		spec_instruction_sb_valid ? spec_instruction_sb_rd_wdata :
		spec_instruction_sd_valid ? spec_instruction_sd_rd_wdata :
		...
		spec_instruction_slliw_valid ? spec_instruction_slliw_rd_wdata :
		spec_instruction_sllw_valid ? spec_instruction_sllw_rd_wdata :
		...
		spec_instruction_sraiw_valid ? spec_instruction_sraiw_rd_wdata :
		spec_instruction_sraw_valid ? spec_instruction_sraw_rd_wdata :
		spec_instruction_srl_valid ? spec_instruction_srl_rd_wdata :
		spec_instruction_srli_valid ? spec_instruction_srli_rd_wdata :
		spec_instruction_srliw_valid ? spec_instruction_srliw_rd_wdata :
		spec_instruction_srlw_valid ? spec_instruction_srlw_rd_wdata :
		spec_instruction_sub_valid ? spec_instruction_sub_rd_wdata :
		spec_instruction_subw_valid ? spec_instruction_subw_rd_wdata :
  ...
  assign spec_pc_wdata =
		...
		spec_instruction_addiw_valid ? spec_instruction_addiw_pc_wdata :
		spec_instruction_addw_valid ? spec_instruction_addw_pc_wdata :
		...
		spec_instruction_c_addiw_valid ? spec_instruction_c_addiw_pc_wdata :
		spec_instruction_c_addw_valid ? spec_instruction_c_addw_pc_wdata :
		...
		spec_instruction_c_ld_valid ? spec_instruction_c_ld_pc_wdata :
		spec_instruction_c_ldsp_valid ? spec_instruction_c_ldsp_pc_wdata :
		...
		spec_instruction_c_sd_valid ? spec_instruction_c_sd_pc_wdata :
		spec_instruction_c_sdsp_valid ? spec_instruction_c_sdsp_pc_wdata :
		...
		spec_instruction_c_subw_valid ? spec_instruction_c_subw_pc_wdata :
		...
		spec_instruction_div_valid ? spec_instruction_div_pc_wdata :
		spec_instruction_divu_valid ? spec_instruction_divu_pc_wdata :
		spec_instruction_divuw_valid ? spec_instruction_divuw_pc_wdata :
		spec_instruction_divw_valid ? spec_instruction_divw_pc_wdata :
		...
		spec_instruction_ld_valid ? spec_instruction_ld_pc_wdata :
		...
		spec_instruction_lwu_valid ? spec_instruction_lwu_pc_wdata :
		spec_instruction_mul_valid ? spec_instruction_mul_pc_wdata :
		spec_instruction_mulh_valid ? spec_instruction_mulh_pc_wdata :
		spec_instruction_mulhsu_valid ? spec_instruction_mulhsu_pc_wdata :
		spec_instruction_mulhu_valid ? spec_instruction_mulhu_pc_wdata :
		spec_instruction_mulw_valid ? spec_instruction_mulw_pc_wdata :
		spec_instruction_or_valid ? spec_instruction_or_pc_wdata :
		spec_instruction_ori_valid ? spec_instruction_ori_pc_wdata :
		spec_instruction_rem_valid ? spec_instruction_rem_pc_wdata :
		spec_instruction_remu_valid ? spec_instruction_remu_pc_wdata :
		spec_instruction_remuw_valid ? spec_instruction_remuw_pc_wdata :
		spec_instruction_remw_valid ? spec_instruction_remw_pc_wdata :
		spec_instruction_sb_valid ? spec_instruction_sb_pc_wdata :
		spec_instruction_sd_valid ? spec_instruction_sd_pc_wdata :
		...
		spec_instruction_slliw_valid ? spec_instruction_slliw_pc_wdata :
		spec_instruction_sllw_valid ? spec_instruction_sllw_pc_wdata :
		...
		spec_instruction_sraiw_valid ? spec_instruction_sraiw_pc_wdata :
		spec_instruction_sraw_valid ? spec_instruction_sraw_pc_wdata :
		spec_instruction_srl_valid ? spec_instruction_srl_pc_wdata :
		spec_instruction_srli_valid ? spec_instruction_srli_pc_wdata :
		spec_instruction_srliw_valid ? spec_instruction_srliw_pc_wdata :
		spec_instruction_srlw_valid ? spec_instruction_srlw_pc_wdata :
		spec_instruction_sub_valid ? spec_instruction_sub_pc_wdata :
		spec_instruction_subw_valid ? spec_instruction_subw_pc_wdata :
  ...
  assign spec_mem_addr =
		...
		spec_instruction_addiw_valid ? spec_instruction_addiw_mem_addr :
		spec_instruction_addw_valid ? spec_instruction_addw_mem_addr :
		...
		spec_instruction_c_addiw_valid ? spec_instruction_c_addiw_mem_addr :
		spec_instruction_c_addw_valid ? spec_instruction_c_addw_mem_addr :
		...
		spec_instruction_c_ld_valid ? spec_instruction_c_ld_mem_addr :
		spec_instruction_c_ldsp_valid ? spec_instruction_c_ldsp_mem_addr :
		...
		spec_instruction_c_sd_valid ? spec_instruction_c_sd_mem_addr :
		spec_instruction_c_sdsp_valid ? spec_instruction_c_sdsp_mem_addr :
		...
		spec_instruction_c_subw_valid ? spec_instruction_c_subw_mem_addr :
		...
		spec_instruction_div_valid ? spec_instruction_div_mem_addr :
		spec_instruction_divu_valid ? spec_instruction_divu_mem_addr :
		spec_instruction_divuw_valid ? spec_instruction_divuw_mem_addr :
		spec_instruction_divw_valid ? spec_instruction_divw_mem_addr :
		...
		spec_instruction_ld_valid ? spec_instruction_ld_mem_addr :
		...
		spec_instruction_lwu_valid ? spec_instruction_lwu_mem_addr :
		spec_instruction_mul_valid ? spec_instruction_mul_mem_addr :
		spec_instruction_mulh_valid ? spec_instruction_mulh_mem_addr :
		spec_instruction_mulhsu_valid ? spec_instruction_mulhsu_mem_addr :
		spec_instruction_mulhu_valid ? spec_instruction_mulhu_mem_addr :
		spec_instruction_mulw_valid ? spec_instruction_mulw_mem_addr :
		spec_instruction_or_valid ? spec_instruction_or_mem_addr :
		spec_instruction_ori_valid ? spec_instruction_ori_mem_addr :
		spec_instruction_rem_valid ? spec_instruction_rem_mem_addr :
		spec_instruction_remu_valid ? spec_instruction_remu_mem_addr :
		spec_instruction_remuw_valid ? spec_instruction_remuw_mem_addr :
		spec_instruction_remw_valid ? spec_instruction_remw_mem_addr :
		spec_instruction_sb_valid ? spec_instruction_sb_mem_addr :
		spec_instruction_sd_valid ? spec_instruction_sd_mem_addr :
		...
		spec_instruction_slliw_valid ? spec_instruction_slliw_mem_addr :
		spec_instruction_sllw_valid ? spec_instruction_sllw_mem_addr :
		...
		spec_instruction_sraiw_valid ? spec_instruction_sraiw_mem_addr :
		spec_instruction_sraw_valid ? spec_instruction_sraw_mem_addr :
		spec_instruction_srl_valid ? spec_instruction_srl_mem_addr :
		spec_instruction_srli_valid ? spec_instruction_srli_mem_addr :
		spec_instruction_srliw_valid ? spec_instruction_srliw_mem_addr :
		spec_instruction_srlw_valid ? spec_instruction_srlw_mem_addr :
		spec_instruction_sub_valid ? spec_instruction_sub_mem_addr :
		spec_instruction_subw_valid ? spec_instruction_subw_mem_addr :
  ...
  assign spec_mem_rmask =
		...
		spec_instruction_addiw_valid ? spec_instruction_addiw_mem_rmask :
		spec_instruction_addw_valid ? spec_instruction_addw_mem_rmask :
		...
		spec_instruction_c_addiw_valid ? spec_instruction_c_addiw_mem_rmask :
		spec_instruction_c_addw_valid ? spec_instruction_c_addw_mem_rmask :
		...
		spec_instruction_c_ld_valid ? spec_instruction_c_ld_mem_rmask :
		spec_instruction_c_ldsp_valid ? spec_instruction_c_ldsp_mem_rmask :
		...
		spec_instruction_c_sd_valid ? spec_instruction_c_sd_mem_rmask :
		spec_instruction_c_sdsp_valid ? spec_instruction_c_sdsp_mem_rmask :
		...
		spec_instruction_c_subw_valid ? spec_instruction_c_subw_mem_rmask :
		...
		spec_instruction_div_valid ? spec_instruction_div_mem_rmask :
		spec_instruction_divu_valid ? spec_instruction_divu_mem_rmask :
		spec_instruction_divuw_valid ? spec_instruction_divuw_mem_rmask :
		spec_instruction_divw_valid ? spec_instruction_divw_mem_rmask :
		...
		spec_instruction_ld_valid ? spec_instruction_ld_mem_rmask :
		...
		spec_instruction_lwu_valid ? spec_instruction_lwu_mem_rmask :
		spec_instruction_mul_valid ? spec_instruction_mul_mem_rmask :
		spec_instruction_mulh_valid ? spec_instruction_mulh_mem_rmask :
		spec_instruction_mulhsu_valid ? spec_instruction_mulhsu_mem_rmask :
		spec_instruction_mulhu_valid ? spec_instruction_mulhu_mem_rmask :
		spec_instruction_mulw_valid ? spec_instruction_mulw_mem_rmask :
		spec_instruction_or_valid ? spec_instruction_or_mem_rmask :
		spec_instruction_ori_valid ? spec_instruction_ori_mem_rmask :
		spec_instruction_rem_valid ? spec_instruction_rem_mem_rmask :
		spec_instruction_remu_valid ? spec_instruction_remu_mem_rmask :
		spec_instruction_remuw_valid ? spec_instruction_remuw_mem_rmask :
		spec_instruction_remw_valid ? spec_instruction_remw_mem_rmask :
		spec_instruction_sb_valid ? spec_instruction_sb_mem_rmask :
		spec_instruction_sd_valid ? spec_instruction_sd_mem_rmask :
		...
		spec_instruction_slliw_valid ? spec_instruction_slliw_mem_rmask :
		spec_instruction_sllw_valid ? spec_instruction_sllw_mem_rmask :
		...
		spec_instruction_sraiw_valid ? spec_instruction_sraiw_mem_rmask :
		spec_instruction_sraw_valid ? spec_instruction_sraw_mem_rmask :
		spec_instruction_srl_valid ? spec_instruction_srl_mem_rmask :
		spec_instruction_srli_valid ? spec_instruction_srli_mem_rmask :
		spec_instruction_srliw_valid ? spec_instruction_srliw_mem_rmask :
		spec_instruction_srlw_valid ? spec_instruction_srlw_mem_rmask :
		spec_instruction_sub_valid ? spec_instruction_sub_mem_rmask :
		spec_instruction_subw_valid ? spec_instruction_subw_mem_rmask :
  ...
  assign spec_mem_wmask =
		...
		spec_instruction_addiw_valid ? spec_instruction_addiw_mem_wmask :
		spec_instruction_addw_valid ? spec_instruction_addw_mem_wmask :
		...
		spec_instruction_c_addiw_valid ? spec_instruction_c_addiw_mem_wmask :
		spec_instruction_c_addw_valid ? spec_instruction_c_addw_mem_wmask :
		...
		spec_instruction_c_ld_valid ? spec_instruction_c_ld_mem_wmask :
		spec_instruction_c_ldsp_valid ? spec_instruction_c_ldsp_mem_wmask :
		...
		spec_instruction_c_sd_valid ? spec_instruction_c_sd_mem_wmask :
		spec_instruction_c_sdsp_valid ? spec_instruction_c_sdsp_mem_wmask :
		...
		spec_instruction_c_subw_valid ? spec_instruction_c_subw_mem_wmask :
		...
		spec_instruction_div_valid ? spec_instruction_div_mem_wmask :
		spec_instruction_divu_valid ? spec_instruction_divu_mem_wmask :
		spec_instruction_divuw_valid ? spec_instruction_divuw_mem_wmask :
		spec_instruction_divw_valid ? spec_instruction_divw_mem_wmask :
		...
		spec_instruction_ld_valid ? spec_instruction_ld_mem_wmask :
		...
		spec_instruction_lwu_valid ? spec_instruction_lwu_mem_wmask :
		spec_instruction_mul_valid ? spec_instruction_mul_mem_wmask :
		spec_instruction_mulh_valid ? spec_instruction_mulh_mem_wmask :
		spec_instruction_mulhsu_valid ? spec_instruction_mulhsu_mem_wmask :
		spec_instruction_mulhu_valid ? spec_instruction_mulhu_mem_wmask :
		spec_instruction_mulw_valid ? spec_instruction_mulw_mem_wmask :
		spec_instruction_or_valid ? spec_instruction_or_mem_wmask :
		spec_instruction_ori_valid ? spec_instruction_ori_mem_wmask :
		spec_instruction_rem_valid ? spec_instruction_rem_mem_wmask :
		spec_instruction_remu_valid ? spec_instruction_remu_mem_wmask :
		spec_instruction_remuw_valid ? spec_instruction_remuw_mem_wmask :
		spec_instruction_remw_valid ? spec_instruction_remw_mem_wmask :
		spec_instruction_sb_valid ? spec_instruction_sb_mem_wmask :
		spec_instruction_sd_valid ? spec_instruction_sd_mem_wmask :
		...
		spec_instruction_slliw_valid ? spec_instruction_slliw_mem_wmask :
		spec_instruction_sllw_valid ? spec_instruction_sllw_mem_wmask :
		...
		spec_instruction_sraiw_valid ? spec_instruction_sraiw_mem_wmask :
		spec_instruction_sraw_valid ? spec_instruction_sraw_mem_wmask :
		spec_instruction_srl_valid ? spec_instruction_srl_mem_wmask :
		spec_instruction_srli_valid ? spec_instruction_srli_mem_wmask :
		spec_instruction_srliw_valid ? spec_instruction_srliw_mem_wmask :
		spec_instruction_srlw_valid ? spec_instruction_srlw_mem_wmask :
		spec_instruction_sub_valid ? spec_instruction_sub_mem_wmask :
		spec_instruction_subw_valid ? spec_instruction_subw_mem_wmask :
  ...
  assign spec_mem_wdata =
		...
		spec_instruction_addiw_valid ? spec_instruction_addiw_mem_wdata :
		spec_instruction_addw_valid ? spec_instruction_addw_mem_wdata :
		...
		spec_instruction_c_addiw_valid ? spec_instruction_c_addiw_mem_wdata :
		spec_instruction_c_addw_valid ? spec_instruction_c_addw_mem_wdata :
		...
		spec_instruction_c_ld_valid ? spec_instruction_c_ld_mem_wdata :
		spec_instruction_c_ldsp_valid ? spec_instruction_c_ldsp_mem_wdata :
		...
		spec_instruction_c_sd_valid ? spec_instruction_c_sd_mem_wdata :
		spec_instruction_c_sdsp_valid ? spec_instruction_c_sdsp_mem_wdata :
		...
		spec_instruction_c_subw_valid ? spec_instruction_c_subw_mem_wdata :
		...
		spec_instruction_div_valid ? spec_instruction_div_mem_wdata :
		spec_instruction_divu_valid ? spec_instruction_divu_mem_wdata :
		spec_instruction_divuw_valid ? spec_instruction_divuw_mem_wdata :
		spec_instruction_divw_valid ? spec_instruction_divw_mem_wdata :
		...
		spec_instruction_ld_valid ? spec_instruction_ld_mem_wdata :
		...
		spec_instruction_lwu_valid ? spec_instruction_lwu_mem_wdata :
		spec_instruction_mul_valid ? spec_instruction_mul_mem_wdata :
		spec_instruction_mulh_valid ? spec_instruction_mulh_mem_wdata :
		spec_instruction_mulhsu_valid ? spec_instruction_mulhsu_mem_wdata :
		spec_instruction_mulhu_valid ? spec_instruction_mulhu_mem_wdata :
		spec_instruction_mulw_valid ? spec_instruction_mulw_mem_wdata :
		spec_instruction_or_valid ? spec_instruction_or_mem_wdata :
		spec_instruction_ori_valid ? spec_instruction_ori_mem_wdata :
		spec_instruction_rem_valid ? spec_instruction_rem_mem_wdata :
		spec_instruction_remu_valid ? spec_instruction_remu_mem_wdata :
		spec_instruction_remuw_valid ? spec_instruction_remuw_mem_wdata :
		spec_instruction_remw_valid ? spec_instruction_remw_mem_wdata :
		spec_instruction_sb_valid ? spec_instruction_sb_mem_wdata :
		spec_instruction_sd_valid ? spec_instruction_sd_mem_wdata :
		...
		spec_instruction_slliw_valid ? spec_instruction_slliw_mem_wdata :
		spec_instruction_sllw_valid ? spec_instruction_sllw_mem_wdata :
		...
		spec_instruction_sraiw_valid ? spec_instruction_sraiw_mem_wdata :
		spec_instruction_sraw_valid ? spec_instruction_sraw_mem_wdata :
		spec_instruction_srl_valid ? spec_instruction_srl_mem_wdata :
		spec_instruction_srli_valid ? spec_instruction_srli_mem_wdata :
		spec_instruction_srliw_valid ? spec_instruction_srliw_mem_wdata :
		spec_instruction_srlw_valid ? spec_instruction_srlw_mem_wdata :
		spec_instruction_sub_valid ? spec_instruction_sub_mem_wdata :
		spec_instruction_subw_valid ? spec_instruction_subw_mem_wdata :
...
`ifdef RISCV_FORMAL_CSR_MISA
  assign spec_csr_misa_rmask =
		...
		spec_instruction_addiw_valid ? spec_instruction_addiw_csr_misa_rmask :
		spec_instruction_addw_valid ? spec_instruction_addw_csr_misa_rmask :
		...
		spec_instruction_c_addiw_valid ? spec_instruction_c_addiw_csr_misa_rmask :
		spec_instruction_c_addw_valid ? spec_instruction_c_addw_csr_misa_rmask :
		...
		spec_instruction_c_ld_valid ? spec_instruction_c_ld_csr_misa_rmask :
		spec_instruction_c_ldsp_valid ? spec_instruction_c_ldsp_csr_misa_rmask :
		...
		spec_instruction_c_sd_valid ? spec_instruction_c_sd_csr_misa_rmask :
		spec_instruction_c_sdsp_valid ? spec_instruction_c_sdsp_csr_misa_rmask :
		...
		spec_instruction_c_subw_valid ? spec_instruction_c_subw_csr_misa_rmask :
		...
		spec_instruction_div_valid ? spec_instruction_div_csr_misa_rmask :
		spec_instruction_divu_valid ? spec_instruction_divu_csr_misa_rmask :
		spec_instruction_divuw_valid ? spec_instruction_divuw_csr_misa_rmask :
		spec_instruction_divw_valid ? spec_instruction_divw_csr_misa_rmask :
		...
		spec_instruction_ld_valid ? spec_instruction_ld_csr_misa_rmask :
		...
		spec_instruction_lwu_valid ? spec_instruction_lwu_csr_misa_rmask :
		spec_instruction_mul_valid ? spec_instruction_mul_csr_misa_rmask :
		spec_instruction_mulh_valid ? spec_instruction_mulh_csr_misa_rmask :
		spec_instruction_mulhsu_valid ? spec_instruction_mulhsu_csr_misa_rmask :
		spec_instruction_mulhu_valid ? spec_instruction_mulhu_csr_misa_rmask :
		spec_instruction_mulw_valid ? spec_instruction_mulw_csr_misa_rmask :
		...
		spec_instruction_rem_valid ? spec_instruction_rem_csr_misa_rmask :
		spec_instruction_remu_valid ? spec_instruction_remu_csr_misa_rmask :
		spec_instruction_remuw_valid ? spec_instruction_remuw_csr_misa_rmask :
		spec_instruction_remw_valid ? spec_instruction_remw_csr_misa_rmask :
		spec_instruction_sb_valid ? spec_instruction_sb_csr_misa_rmask :
		spec_instruction_sd_valid ? spec_instruction_sd_csr_misa_rmask :
		...
		spec_instruction_slliw_valid ? spec_instruction_slliw_csr_misa_rmask :
		spec_instruction_sllw_valid ? spec_instruction_sllw_csr_misa_rmask :
		...
		spec_instruction_sraiw_valid ? spec_instruction_sraiw_csr_misa_rmask :
		spec_instruction_sraw_valid ? spec_instruction_sraw_csr_misa_rmask :
		...
		spec_instruction_srliw_valid ? spec_instruction_srliw_csr_misa_rmask :
		spec_instruction_srlw_valid ? spec_instruction_srlw_csr_misa_rmask :
		spec_instruction_sub_valid ? spec_instruction_sub_csr_misa_rmask :
		spec_instruction_subw_valid ? spec_instruction_subw_csr_misa_rmask :
