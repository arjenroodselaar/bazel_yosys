...
`endif
  ...
  assign spec_valid = rvfi_valid && !instruction_padding && instruction_funct7 == 7'b 0100000 && instruction_funct3 == 3'b 000 && instruction_opcode == 7'b 0110011;
