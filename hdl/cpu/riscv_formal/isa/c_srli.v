...
module rvfi_instruction_c_srli (
  input                                 rvfi_valid,
...
`endif
  ...
  // C_SRLI instruction
  wire [`RISCV_FORMAL_XLEN-1:0] result = rvfi_rs1_rdata >> instruction_shamt;
  assign spec_valid = rvfi_valid && !instruction_padding && instruction_funct3 == 3'b 100 && instruction_funct2 == 2'b 00 && instruction_opcode == 2'b 01 && (!instruction_shamt[5] || `RISCV_FORMAL_XLEN == 64);
