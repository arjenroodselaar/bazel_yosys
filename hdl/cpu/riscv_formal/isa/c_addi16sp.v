...
module rvfi_instruction_c_addi16sp (
  input                                 rvfi_valid,
...
`endif
  ...
  wire [`RISCV_FORMAL_XLEN-1:0] instruction_imm = $signed({rvfi_instruction[12], rvfi_instruction[4:3], rvfi_instruction[5], rvfi_instruction[2], rvfi_instruction[6], 4'b0});
...
`endif
  ...
  wire [`RISCV_FORMAL_XLEN-1:0] result = rvfi_rs1_rdata + instruction_imm;
  assign spec_valid = rvfi_valid && !instruction_padding && instruction_funct3 == 3'b 011 && instruction_opcode == 2'b 01 && instruction_rs1_rd == 5'd 2 && instruction_imm;
