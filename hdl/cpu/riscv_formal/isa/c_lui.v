...
`endif
  ...
  wire [`RISCV_FORMAL_XLEN-1:0] instruction_imm = $signed({rvfi_instruction[12], rvfi_instruction[6:2], 12'b0});
...
`endif
  ...
  // C_LUI instruction
  wire [`RISCV_FORMAL_XLEN-1:0] result = instruction_imm;
