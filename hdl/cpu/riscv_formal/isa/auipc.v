...
`endif
  ...
  wire [`RISCV_FORMAL_XLEN-1:0] instruction_imm = $signed({rvfi_instruction[31:12], 12'b0});
...
`endif
  ...
  // AUIPC instruction
  assign spec_valid = rvfi_valid && !instruction_padding && instruction_opcode == 7'b 0010111;
  assign spec_rd_addr = instruction_rd;
  assign spec_rd_wdata = spec_rd_addr ? rvfi_pc_rdata + instruction_imm : 0;
