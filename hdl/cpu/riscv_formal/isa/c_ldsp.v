...
module rvfi_instruction_c_ldsp (
  input                                 rvfi_valid,
...
`endif
  ...
  wire [`RISCV_FORMAL_XLEN-1:0] instruction_imm = {rvfi_instruction[4:2], rvfi_instruction[12], rvfi_instruction[6:5], 3'b000};
...
`ifdef RISCV_FORMAL_ALIGNED_MEM
  ...
  assign spec_valid = rvfi_valid && !instruction_padding && instruction_funct3 == 3'b 011 && instruction_opcode == 2'b 10 && instruction_rd;
