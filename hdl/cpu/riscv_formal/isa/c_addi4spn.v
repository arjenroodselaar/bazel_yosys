...
module rvfi_instruction_c_addi4spn (
  input                                 rvfi_valid,
...
`endif
  ...
  wire [`RISCV_FORMAL_XLEN-1:0] instruction_imm = {rvfi_instruction[10:7], rvfi_instruction[12:11], rvfi_instruction[5], rvfi_instruction[6], 2'b00};
...
`endif
  ...
  assign spec_valid = rvfi_valid && !instruction_padding && instruction_funct3 == 3'b 000 && instruction_opcode == 2'b 00 && instruction_imm;
