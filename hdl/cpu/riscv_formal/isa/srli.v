...
`endif
  ...
  assign spec_valid = rvfi_valid && !instruction_padding && instruction_funct6 == 6'b 000000 && instruction_funct3 == 3'b 101 && instruction_opcode == 7'b 0010011 && (!instruction_shamt[5] || `RISCV_FORMAL_XLEN == 64);
