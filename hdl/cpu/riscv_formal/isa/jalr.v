...
`endif
  ...
  // JALR instruction
  wire [`RISCV_FORMAL_XLEN-1:0] next_pc = (rvfi_rs1_rdata + instruction_imm) & ~1;
  assign spec_valid = rvfi_valid && !instruction_padding && instruction_funct3 == 3'b 000 && instruction_opcode == 7'b 1100111;
