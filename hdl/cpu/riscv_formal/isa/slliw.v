...
`endif
  ...
  assign spec_valid = rvfi_valid && !instruction_padding && instruction_funct6 == 6'b 000000 && instruction_funct3 == 3'b 001 && instruction_opcode == 7'b 0011011 && !instruction_shamt[5];
