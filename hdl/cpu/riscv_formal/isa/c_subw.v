...
module rvfi_instruction_c_subw (
  input                                 rvfi_valid,
...
`endif
  ...
  assign spec_valid = rvfi_valid && !instruction_padding && instruction_funct6 == 6'b 100111 && instruction_funct2 == 2'b 00 && instruction_opcode == 2'b 01;
