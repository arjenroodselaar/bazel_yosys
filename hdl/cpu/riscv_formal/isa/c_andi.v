...
module rvfi_instruction_c_andi (
  input                                 rvfi_valid,
...
`endif
  ...
  wire [`RISCV_FORMAL_XLEN-1:0] instruction_imm = $signed({rvfi_instruction[12], rvfi_instruction[6:2]});
...
`endif
  ...
  assign spec_valid = rvfi_valid && !instruction_padding && instruction_funct3 == 3'b 100 && instruction_funct2 == 2'b 10 && instruction_opcode == 2'b 01;
