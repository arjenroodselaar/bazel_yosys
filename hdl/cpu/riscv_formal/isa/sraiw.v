...
`endif
  ...
  // SRAIW instruction
  wire [31:0] result = $signed(rvfi_rs1_rdata[31:0]) >>> instruction_shamt;
  assign spec_valid = rvfi_valid && !instruction_padding && instruction_funct6 == 6'b 010000 && instruction_funct3 == 3'b 101 && instruction_opcode == 7'b 0011011 && !instruction_shamt[5];
