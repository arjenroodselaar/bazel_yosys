...
`ifdef RISCV_FORMAL_ALIGNED_MEM
  ...
  assign spec_valid = rvfi_valid && !instruction_padding && instruction_funct3 == 3'b 110 && instruction_opcode == 7'b 0000011;
...
`else
  ...
  assign spec_valid = rvfi_valid && instruction_funct3 == 3'b 110 && instruction_opcode == 7'b 0000011;
  assign spec_rs1_addr = instruction_rs1;
  assign spec_rd_addr = instruction_rd;
