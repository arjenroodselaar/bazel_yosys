...
`endif
  ...
  assign spec_valid = rvfi_valid && !instruction_padding && instruction_funct7 == 7'b 0000000 && instruction_funct3 == 3'b 001 && instruction_opcode == 7'b 0110011;
